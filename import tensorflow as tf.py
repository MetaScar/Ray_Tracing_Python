...
def OrdinaryWavePropagation(rx_init, ry_init, rz_init, pox_init, poy_init, poz_init, mat, time_step, E):
...
def ExtraordinaryWavePropagation(rx_init, ry_init, rz_init, pex_init, pey_init, pez_init, mat, time_step, E):
