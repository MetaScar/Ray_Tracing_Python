...
boundingBox = Material([], "sphere", [0,0,0,0,0.7], [], [], [], [], [], [], [], [], [])
...
with tf.GradientTape(persistent=True) as tape:
    ...
    mat1 = Material(True, "sphere", [0,0,0,0,0.3], a0_1, a1_1, a2_1, b0, b1, b2, c0, c1, c2)
    mat2 = Material(True, "sphere", [0,0,0,0.3,0.7], a0_2, a1_2, a2_2, [], [], [], [], [], [])
    ...
    incident_position = [tf.constant(0.0), tf.constant(0.0), tf.constant(-0.4999999)]
    ...
    incident_position = [tf.constant(0.10), tf.constant(0.0), tf.constant(-0.4999999)]
    ...
    incident_position = [tf.constant(-0.10), tf.constant(0.0), tf.constant(-0.4999999)]
    Ei_2 = [tf.constant(0.0, dtype=tf.complex64), tf.constant(1.0, dtype=tf.complex64), tf.constant(0.0, dtype=tf.complex64)]
    ...
    f = of.focusObjective(cpRays, 0.3, 0)
